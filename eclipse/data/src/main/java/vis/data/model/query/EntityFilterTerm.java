...
public class EntityFilterTerm extends Term.Filter {
	...
	public EntityFilterTerm(Parameters p) throws SQLException {
		if(p.lemmaIds_ != null) {
			lemmas_ = p.lemmaIds_;
	...
	public boolean equals(Object other) {
		if(other.getClass() != EntityFilterTerm.class)
			return false;
		EntityFilterTerm o = (EntityFilterTerm)other;
		return Arrays.equals(lemmas_, o.lemmas_);
	}
	@Override
	public int hashCode() {
		return Arrays.hashCode(lemmas_) ^ EntityFilterTerm.class.hashCode();
	}
}
